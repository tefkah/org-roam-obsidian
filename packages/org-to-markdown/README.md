...
Convert a directory of Org files to Markdown
...
```sh
yarn add org-to-markdown
```

or with [npm](https://docs.npmjs.com/cli/install)

```sh
npm install org-to-markdown
```
...
[org-to-markdown]: https://github.com/journaloftrialanderror/jote/tree/main/libs/org-to-markdown
