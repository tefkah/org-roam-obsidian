# orgast-util-properties-to-json

Return the properties as a json thingy

## Contents

- [orgast-util-properties-to-json](#orgast-util-properties-to-json)
  - [Contents](#contents)
...
```sh
yarn add orgast-util-properties-to-json
```

or with [npm](https://docs.npmjs.com/cli/install)

```sh
npm install orgast-util-properties-to-json
```
...
[orgast-util-properties-to-json]: https://github.com/journaloftrialanderror/jote/tree/main/libs/orgast-util-properties-to-json
