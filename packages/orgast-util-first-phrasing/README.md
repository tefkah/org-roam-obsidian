# orgast-util-first-phrasing

Return the first &#39;text&#39; element in an org file, e.g. the first heading, paragraph, or word. Mostly used to check for duplicated headlines/titles.

## Contents

- [orgast-util-first-phrasing](#orgast-util-first-phrasing)
  - [Contents](#contents)
...
```sh
yarn add orgast-util-first-phrasing
```

or with [npm](https://docs.npmjs.com/cli/install)

```sh
npm install orgast-util-first-phrasing
```
...
[orgast]: https://github.com/journaloftrialanderror/jote/tree/main/libs/rejour/orgast
[orgast-util-to-mdast]: https://github.com/journaloftrialanderror/jote/tree/main/libs/rejour/orgast-util-to-mdast
[orgastscript]: https://github.com/journaloftrialanderror/jote/tree/main/libs/rejour/orgastscript
[mdast]: https://github.com/journaloftrialanderror/jote/tree/main/libs/relatex/mdast
[mdast-util-to-latex]: https://github.com/journaloftrialanderror/jote/tree/main/libs/relatex/mdast-util-to-latex
...
[ooxast]: https://github.com/journaloftrialanderror/jote/tree/main/libs/ooxast/ooxast-util-to-orgast
[orgast-util-first-phrasing]: https://github.com/journaloftrialanderror/jote/tree/main/libs/orgast-util-first-phrasing
