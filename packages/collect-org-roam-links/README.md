# collect-org-roam-links

Collect all the org-roam-ids in a folder and convert them to a json object

## Contents

- [collect-org-roam-links](#collect-org-roam-links)
  - [Contents](#contents)
...
```sh
yarn add collect-org-roam-links
```

or with [npm](https://docs.npmjs.com/cli/install)

```sh
npm install collect-org-roam-links
```
...
[collect-org-roam-links]: https://github.com/journaloftrialanderror/jote/tree/main/libs/collect-org-roam-links
