import { isElement, Title } from 'uniorg-types'
import { CommandArg, CommandArgOpt, EnvironmentContent } from 'mdast'
import { all } from '../all'
    ...
    children: [
      {
        type: 'commandArg',
        optional: false,
        // TODO: [orgast-util-to-mdast] Figure out how to properly nest environments and commands
        // @ts-expect-error
