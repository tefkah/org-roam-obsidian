# orgast-util-to-mdast

Util to translate orgast trees to mdast

## Contents

- [orgast-util-to-mdast](#orgast-util-to-mdast)
  - [Contents](#contents)
...
```sh
yarn add orgast-util-to-mdast
```

or with [npm](https://docs.npmjs.com/cli/install)

```sh
npm install orgast-util-to-mdast
```
...
[orgast-util-to-mdast]: https://github.com/journaloftrialanderror/jote/tree/main/libs/orgast-util-to-mdast
